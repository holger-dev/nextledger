        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <NcDateTimePickerNative
              ...
              :label="t('validUntil')"
              type="date"
              :value="validUntilPicker"
              @input="validUntilPicker = $event"
            />
...
export default {
  ...
  computed: {
    ...
    validUntilPicker: {
      get() {
        return toDateFromInput(this.form.validUntil)
      },
      set(value) {
        this.form.validUntil = toInputFromDate(value)
      },
    },
    customerOptions() {
